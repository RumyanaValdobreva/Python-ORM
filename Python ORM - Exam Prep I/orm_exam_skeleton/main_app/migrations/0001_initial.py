# Generated by Django 5.0.4 on 2024-07-29 19:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_awarded', models.BooleanField(default=False)),
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('title', models.CharField(max_length=150, validators=[django.core.validators.MinValueValidator(5)])),
                ...
                ('starring_actor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='starring_actors_movie', to='main_app.actor')),
            ],
            options={
                'abstract': False,
            },
